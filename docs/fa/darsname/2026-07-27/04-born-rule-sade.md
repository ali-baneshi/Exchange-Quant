...
**نسخه frozen:** `born_constructive_v1` — `saturation_gate` safeguard وقتی overshoot > 0.15 یا pred≥0.99.
...
**۵. destructive?**  
طراحی frozen: تداخل منفی → `classical_part`؛ overshoot سازنده → `saturation_gate`.
