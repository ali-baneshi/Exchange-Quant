...
This compared adaptive vs fixed-weight ensemble with quantum on klines.
...
warnings.warn(
    "backtest_boost.py is deprecated (Born rule removed from klines)",
    DeprecationWarning,
    stacklevel=2,
)
...
def main():
    print("""
    ========================================================================
      backtest_boost.py — DEPRECATED (exit code 1)
      ...
      not available in historical klines.
